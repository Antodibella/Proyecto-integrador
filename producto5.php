...
<head>
    ...
    <title>SAMSUNG S9 - Tecno Movil</title>
</head>
<body class="producto">
   <!--  BARRA DE INICIO -->
<header>
    ...
    <div class="products">
        <div class="row">
            <div class="col-md-9 col-lg-4">
                <br>
                    <img src="img/samsung-galaxy-s9-001.jpg" alt="logotipo" class="img-fluid mb-3">
            ...
            <div class="row-description">
                ...
                <hr>
                <ul><li><strong>PRECIO: 29.000 ARS</strong></li></ul>
                <button type="button" class="btn btn-outline-success"><a href="carrito.php?nombre=Samsung-S9&precio=29000">Comprar ahora</button></a>
