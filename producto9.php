...
<head>
    ...
    <title>Motorola G7 - Tecno Movil</title>
</head>
<body class="producto">
   <!--  BARRA DE INICIO -->
<header>
    ...
    <div class="products">
        <div class="row">
            <div class="col-md-9 col-lg-4">
                <br>
                    <img src="img/moto-g7.jpg" alt="logotipo" class="img-fluid mb-3">
            ...
            <div class="row-description">
                ...
                <hr>
                <ul><li><strong>PRECIO: 18.000 ARS</strong></li></ul>
                <button type="button" class="btn btn-outline-success"><a href="carrito.php?nombre=Motorola-Moto-G7&precio=18000">Comprar ahora</button></a>
