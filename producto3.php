...
<head>
    ...
    <title>Iphone 11 Pro MAX - Tecno Movil</title>
</head>
<body class="producto">
   <!--  BARRA DE INICIO -->
<header>
    ...
    <div class="products">
        <div class="row">
            <div class="col-md-9 col-lg-4">
                <br>
                    <img src="img/apple-iphone-11-pro-1.jpg" alt="logotipo" class="img-fluid mb-3">
            ...
            <div class="row-description">
                ...
                <button type="button" class="btn btn-outline-success"><a href="carrito.php?nombre=Iphone-11-ProMax&precio=125000">Comprar ahora</button></a>
