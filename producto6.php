...
<head>
    ...
    <title>SAMSUNG S10 - Tecno Movil</title>
</head>
<body class="producto">
  <!--  BARRA DE INICIO -->
<header>
    ...
    <div class="products">
        <div class="row">
            <div class="col-md-9 col-lg-4">
                <br>
                    <img src="img/samsung-galaxy-S10plus.jpg" alt="logotipo" class="img-fluid mb-3">
            ...
            <div class="row-description">
                ...
                <ul>
                    ...
                    <hr>
                    <li>Liberado</li>
                    <li>Procesador 2.84GHz Snapdragon 855 / 2.73GHz Exynos 9820, dependiendo del mercado</li>
                    <li>Pantalla 6.4 pulgadas, primera pantalla de celular con certificación HDR+ (Dynamic OLED)</li>
                    <li>Cámara trasera de 12 MP f/1.8</li>
                    <li>Cámara delantera 7 MP f/2.2</li>
                    <li>Bateria 4,100mAh (no extraíble)</li>
                    <li>Resistencia al agua y al polvo IP67</li>
                    <li>Memoria interna: <strong> 256 GB</strong></li>
                </ul>
                <hr>
                <ul><li><strong>PRECIO: 125.000 ARS</strong></li></ul>
                <button type="button" class="btn btn-outline-success"><a href="carrito.php?nombre=Samsung-S10-Plus&precio=125000">Comprar ahora</button></a>
